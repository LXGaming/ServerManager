...
public interface SessionHandler {
    ...
    default boolean handle(CommandPacket packet) {
        return false;
    }
    ...
    default boolean handle(IntentPacket packet) {
        return false;
    }
    
    default boolean handle(ListPacket.Request packet) {
        return false;
    }
    
    default boolean handle(ListPacket.Response packet) {
        return false;
    }
