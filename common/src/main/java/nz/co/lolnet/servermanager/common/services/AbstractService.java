...
package nz.co.lolnet.servermanager.common.services;
...
public abstract class AbstractService implements Runnable {
    ...
    public final void run() {
        try {
            ...
            AbstractServerManager.getInstance().getLogger().error("Encountered an error processing {}::run", getClass().getSimpleName(), ex);
